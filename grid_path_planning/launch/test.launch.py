...
def generate_launch_description():
    share_dir = get_package_share_directory('grid_path_planning')
    ...
    grid_path_planning_node = launch_ros.actions.Node(
        package='grid_path_planning',
        executable='grid_path_planning',
        namespace='',
        output="screen",
        parameters=[os.path.join(share_dir, "config", "grid_path_planning_param.yaml")],
        respawn=True,
    )
